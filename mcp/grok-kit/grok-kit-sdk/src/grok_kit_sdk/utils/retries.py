...
def _get_sleep_interval(
    ...
    """
    if isinstance(exception, TemporaryError) and exception.retry_after is not None and exception.retry_after > 0:
...
def retry_with_backoff(
    ...
    while True:
        try:
            ...
            sleep = _get_sleep_interval(exception, initial_interval, max_interval, exponent, retries)
            time.sleep(sleep)
            retries += 1
