...
def get_security(security: Any, allowed_fields: list[str] | None = None) -> tuple[dict[str, str], dict[str, list[str]]]:
    ...
    sec_field_names = list(sec_fields.keys()) if allowed_fields is None else allowed_fields
...
def _parse_security_option(headers: dict[str, str], query_params: dict[str, list[str]], option: Any):
    ...
    for name in opt_fields:
        ...
        if metadata.scheme_type == 'http' and metadata.sub_type == 'basic' and not isinstance(value, BaseModel):
