...
class OpenEnumMeta(enum.EnumMeta):
    ...
    def __new__(mcs, name, bases, namespace, **kwargs):
        ...
        def __get_pydantic_core_schema__(cls_inner: Any, _source_type: Any, _handler: Any) -> core_schema.CoreSchema:
            ...
            base_schema = core_schema.int_schema() if is_int_enum else core_schema.str_schema()
