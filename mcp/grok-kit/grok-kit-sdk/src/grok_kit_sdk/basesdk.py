...
from grok_kit_sdk import errors, utils
from grok_kit_sdk._hooks import (
    AfterErrorContext,
    AfterSuccessContext,
    BeforeRequestContext,
    HookContext,
)
from grok_kit_sdk.utils import (
    RetryConfig,
...
class BaseSDK:
    ...
    def _build_request_async(
        ...
        allow_empty_value: list[str] | None = None,
    ...
    def do_request(
        ...
        if is_error_status_code(http_res.status_code):
            ...
            if result is not None:
                ...
                raise errors.GrokKitDefaultError('Unexpected error occurred', http_res)
        else:
    ...
    async def do_request_async(
        ...
        async def do():
            http_res = None
            try:
                req = await run_sync_in_thread(hooks.before_request, BeforeRequestContext(hook_ctx), request)
                ...
                _, e = await run_sync_in_thread(hooks.after_error, AfterErrorContext(hook_ctx), None, e)
        ...
        if is_error_status_code(http_res.status_code):
            result, err = await run_sync_in_thread(hooks.after_error, AfterErrorContext(hook_ctx), http_res, None)
            ...
            http_res = await run_sync_in_thread(hooks.after_success, AfterSuccessContext(hook_ctx), http_res)
