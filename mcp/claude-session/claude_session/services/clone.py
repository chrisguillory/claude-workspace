...
class SessionCloneService:
    ...
    async def clone(
        ...
        # Collect session-env files from source session
        ...
        if session_env:
            session_env_cloned = write_session_env(new_session_id, session_env)
            logger.info('Cloned %d session-env files', session_env_cloned)
        else:
            session_env_cloned = 0
        ...
        return RestoreResult(
            ...
            session_env_restored=session_env_cloned,
