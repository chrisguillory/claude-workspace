"""CLI client for selenium-browser MCP server.
...
def pipeline(
    ...
    \b
    Examples:
        selenium-browser pipeline < workflow.json
        selenium-browser pipeline -F workflow.json
        selenium-browser pipeline --on-error continue < steps.json
    """
    if file:
