...
class _Usage(OpenModel):
    ...
    """Bring-Your-Own-Key: whether an upstream provider key billed this request
    instead of OpenRouter credits. Always false for us; not consumed."""
    cost_details: _CostDetails | None = None
