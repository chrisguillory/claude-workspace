"""Shared pytest fixtures for selenium-browser tests."""
...
from tests.selenium_browser.helpers import TreeTestRunner

# Resolve paths for serving fixtures via HTTP
_SELENIUM_PROJECT_ROOT = Path(selenium_browser.__file__).parent.parent
