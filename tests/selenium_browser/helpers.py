...
from selenium_browser.helpers import (
    ARIA_HIDDEN_REASON_KEYS,
    VISUAL_HIDDEN_REASON_KEYS,
    build_page_metadata,
    count_tree_nodes,
)
from selenium_browser.tree_utils import (
    compact_aria_tree,
    compact_visual_tree,
...
class TreeTestRunner:
    ...
    def snapshot(
        ...
        reason_keys = ARIA_HIDDEN_REASON_KEYS if is_aria else VISUAL_HIDDEN_REASON_KEYS
